...
cd /opt/dcf_bld/pkg/dcf
export dcf_VERSION=$(egrep -i -o "\b(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)(-[0-9a-z\-]+(\.[0-9a-z\-]+)*)?(\+[0-9a-z\-]+(\.[0-9a-z\-]+)*)?\b" src/ripple/protocol/impl/BuildInfo.cpp)
...
: ${PKG_OUTDIR:=/opt/dcf_bld/pkg/out}
export PKG_OUTDIR
